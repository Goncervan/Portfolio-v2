...
export const EnglishPresentation = () => {
  ...
  >
    ...
    <div className="w-full flex flex-col md:flex-row border-b-2 py-10 border-gray-600 px-10 sm:px-28">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 2, delay: 0.6 }}
        className="w-full md:w-1/2 h-full flex flex-col items-start pt-5 sm:pt-20 justify-center"
      >
        ...
        <a href="#Contact" className="md:text-2xl bg-customBlue text-white rounded-full px-6 py-2 focus:outline-none mx-auto sm:ml-28 mt-10">
          Contacto
        </a>
      </motion.div>
