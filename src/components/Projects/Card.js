...
export const Card = ({ title, description, img, link, index }) => {
  return (
    <div
      ...
      } justify-between sm:gap-0 gap-5 border-opacity-20 px-10 sm:px-40 py-12`}
    >
      <div className="w-full sm:w-2/5 flex flex-col items-center justify-center sm:h-[275px]">
      ...
      <div className="w-full sm:w-2/5 flex flex-col items-start justify-start sm:h-[275px]">
        {img !== undefined && (
